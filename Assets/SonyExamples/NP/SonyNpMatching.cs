...
public class SonyNpMatching : IScreen
{
    ...
    // Todo - Support new SDK 4.5 method
        if (m_MenuInRoom.AddItem("Set Members As Recently Met", "Set Members in the room as recently met", matchingInitialized && currentRoom != null))
        {
