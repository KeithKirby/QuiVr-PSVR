...
namespace Vive.Plugin.SR
{
    ...
    public class ViveSR_RigidReconstruction
    {
        ...
        public static float AdaptiveMaxGridSize { get; set; }
        public static float AdaptiveMinGridSize { get; set; }
        public static float AdaptiveErrorThres { get; set; }
       ...
       private static void ReconstructionDataCallback(int numFrame, IntPtr poseMtx, IntPtr vertData, int numVert, int vertStride, IntPtr idxData, int numIdx)
        ...
        public static void ExportModel(string filename)
        {
            ...
            {
                ViveSR_Framework.SetParameterFloat(ViveSR_Framework.MODULE_ID_RIGID_RECONSTRUCTION, (int)ReconstructionParam.ADAPTIVE_MAX_GRID, AdaptiveMaxGridSize * 0.01f);   // cm to m
                ViveSR_Framework.SetParameterFloat(ViveSR_Framework.MODULE_ID_RIGID_RECONSTRUCTION, (int)ReconstructionParam.ADAPTIVE_MIN_GRID, AdaptiveMinGridSize * 0.01f);
                ViveSR_Framework.SetParameterFloat(ViveSR_Framework.MODULE_ID_RIGID_RECONSTRUCTION, (int)ReconstructionParam.ADAPTIVE_ERROR_THRES, AdaptiveErrorThres);
            }           
