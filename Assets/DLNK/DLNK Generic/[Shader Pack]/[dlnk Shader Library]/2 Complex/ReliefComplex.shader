    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_8805 = Relief( mul( tangentTransform, viewDirection ).xyz.rgb , _ParallaxMap , Depth , (_HgtMapSmooth*10.0) , node_7427 ).rg;
...
////// Specular:
                ...
                float4 _Cavity_var = tex2D(_Cavity,TRANSFORM_TEX(node_8805, _Cavity));
...
////// Emissive:
                float4 _EmissionMap_var = tex2D(_EmissionMap,TRANSFORM_TEX(node_8805, _EmissionMap));
...
/// Final Color:
    ...
    FallBack "DLNK Shaders/Complex/ReliefSimple"
