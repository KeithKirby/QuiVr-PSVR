...
/////// Diffuse:
                ...
                float3 node_6110 = (pow(1.0-max(0,dot(normalDirection, viewDirection)),_RimLevel)*_RimPower*_RimColor.rgb);
                indirectDiffuse += node_6110; // Diffuse Ambient Light
