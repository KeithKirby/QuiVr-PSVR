...
namespace SWS
{
    ...
    public class splineMoveEditor : moveEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("stopOnReach"));
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("started"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("finished"));
