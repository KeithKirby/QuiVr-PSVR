...
namespace SWS
{
    ...
    public class PathEditor : Editor
    {
        ...
        private void AddWaypointAtIndex(int index)
        {
            ...
            {
                wp.transform.position = _transform.position;
                wp.transform.parent = _transform.transform;
            }
        ...
        {
            PathManager mgr = target as PathManager;
            _transform = mgr.gameObject.transform;
