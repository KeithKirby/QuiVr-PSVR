...
namespace I2.Loc
{
	public partial class Localize
	{
		...
		public void SetFinalTerms_GUIText ( string Main, string Secondary, out string PrimaryTerm, out string SecondaryTerm, bool RemoveNonASCII )
		{
			if (string.IsNullOrEmpty(Secondary) && mTarget_GUIText.font!=null)
				Secondary = mTarget_GUIText.font.name;
			SetFinalTerms (mTarget_GUIText.text, 	Secondary, 	out PrimaryTerm, out SecondaryTerm, RemoveNonASCII);
		}

		public void SetFinalTerms_TextMesh ( string Main, string Secondary, out string PrimaryTerm, out string SecondaryTerm, bool RemoveNonASCII )
		{
			string second = (mTarget_TextMesh.font!=null ? mTarget_TextMesh.font.name : string.Empty);
			SetFinalTerms (mTarget_TextMesh.text, 	second, out PrimaryTerm, out SecondaryTerm, RemoveNonASCII);
		}

		public void SetFinalTerms_GUITexture ( string Main, string Secondary, out string PrimaryTerm, out string SecondaryTerm, bool RemoveNonASCII )
		{
		...
		public void SetFinalTerms_AudioSource ( string Main, string Secondary, out string PrimaryTerm, out string SecondaryTerm, bool RemoveNonASCII )
		{
		...
		public void SetFinalTerms_Child ( string Main, string Secondary, out string PrimaryTerm, out string SecondaryTerm, bool RemoveNonASCII )
		{
			SetFinalTerms (mTarget_Child.name,	string.Empty, 	out PrimaryTerm, out SecondaryTerm, false);
		}

		public void SetFinalTerms_SpriteRenderer ( string Main, string Secondary, out string PrimaryTerm, out string SecondaryTerm, bool RemoveNonASCII )
		{
