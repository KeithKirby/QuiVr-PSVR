...
namespace I2.Loc
{
	...
	public partial class Localize
	{
		...
		void SetFinalTerms_dfButton(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
			string second = (mTarget_dfButton.Font!=null ? mTarget_dfButton.Font.name : string.Empty);
			SetFinalTerms (mTarget_dfButton.Text, second,		out primaryTerm, out secondaryTerm, RemoveNonASCII);
		}

		void SetFinalTerms_dfLabel(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
			string second = (mTarget_dfLabel.Font!=null ? mTarget_dfLabel.Font.name : string.Empty);
			SetFinalTerms (mTarget_dfLabel.Text, second,		out primaryTerm, out secondaryTerm, RemoveNonASCII);
		}

		public void SetFinalTerms_dfPanel(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
			string second = (mTarget_dfPanel.Atlas!=null ? mTarget_dfPanel.Atlas.name : string.Empty);
			SetFinalTerms (mTarget_dfPanel.BackgroundSprite, 	second,	out primaryTerm, out secondaryTerm, RemoveNonASCII);
			
		}
		
		public void SetFinalTerms_dfSprite(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
			string second = (mTarget_dfSprite.Atlas!=null ? mTarget_dfSprite.Atlas.name : string.Empty);
			SetFinalTerms (mTarget_dfSprite.SpriteName, 	second,	out primaryTerm, out secondaryTerm, RemoveNonASCII);
		}
		
		void SetFinalTerms_dfRichTextLabel(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
			string second = (mTarget_dfRichTextLabel.Font!=null ? mTarget_dfRichTextLabel.Font.name : string.Empty);
			SetFinalTerms (mTarget_dfRichTextLabel.Text, second,		out primaryTerm, out secondaryTerm, RemoveNonASCII);
		}
