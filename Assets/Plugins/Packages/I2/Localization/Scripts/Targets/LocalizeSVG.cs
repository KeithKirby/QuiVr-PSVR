...
namespace I2.Loc
{
	...
	public partial class Localize
	{
		...
		void SetFinalTerms_SVGImage(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
			...
			SetFinalTerms (primary, second,		out primaryTerm, out secondaryTerm, RemoveNonASCII);
		}
		
		void SetFinalTerms_SVGRenderer(string Main, string Secondary, out string primaryTerm, out string secondaryTerm, bool RemoveNonASCII)
		{
