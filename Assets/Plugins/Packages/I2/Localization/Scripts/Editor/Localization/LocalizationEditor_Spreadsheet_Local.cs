		...
		void OnGUI_Spreadsheet_Local()
		{
			...
			GUILayout.BeginVertical("Box");
				...
				GUILayout.BeginHorizontal();
					...
					var encodingNames = encodings.Select(e=>e.DisplayName).ToArray();

					int idx = System.Array.IndexOf (encodingNames.ToArray(), mProp_Spreadsheet_LocalCSVEncoding.stringValue);
					if (idx == -1)
						idx = System.Array.IndexOf (encodingNames.ToArray(), "utf-8");
					...
					if (mProp_Spreadsheet_LocalCSVEncoding.stringValue != encodings [idx].Name)
