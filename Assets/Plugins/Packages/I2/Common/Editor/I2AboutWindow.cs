...
namespace I2
{
    ...
    public class I2AboutWindow : EditorWindow
    {
        ...
        public static Dictionary<string, Texture2D> ImagePreviewDictionary = new Dictionary<string, Texture2D>(System.StringComparer.Ordinal);
        ...
        static void LoadDefaultData()
        {
            ...
            PluginsData.Plugins[0] = new PluginData()
            {
                ...
                DocumentationURL = "http://inter-illusion.com/assets/I2SmartEdgeManual/SmartEdge.html",
                TutorialsURL = "http://inter-illusion.com/assets/I2SmartEdgeManual/SmartEdge.html",
                ForumURL = "http://www.inter-illusion.com/forum/i2-smartedge",
                AssetStoreURL = "https://www.assetstore.unity3d.com/en/#!/publisher/5916",
