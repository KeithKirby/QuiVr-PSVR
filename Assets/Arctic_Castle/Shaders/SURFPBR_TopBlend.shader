Shader "ArcticCastle/SURFPBR_TopBlend" {
    Properties {
        ...
        _layer1Metal ("Layer 1 Smoothness", Range(0,1)) = 0
    ...
    SubShader {
        ...
        sampler2D _MainTex, _Spc, _BumpMap, _AO,  _layer1Tex, _layer1Norm; // _DetailBump,
        half3 _layer1Color, _SelfIlum;
        half _Power, _layer1Tiling, _layer1Metal, _Shift, _VMask; //_DetailInt, _DetailTiling,
