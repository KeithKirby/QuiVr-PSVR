namespace VRTK
{
    ...
    public class VRTK_UIGraphicRaycaster : GraphicRaycaster
    {
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            Raycast(canvas, eventCam, ray, ref s_RaycastResults);
        ...
        protected virtual void Raycast(Canvas canvas, Camera eventCamera, Ray ray, ref List<RaycastResult> results)
        {
            ...
            for (int i = 0; i < canvasGraphics.Count; ++i)
            {
                ...
                int Gdepth = graphic.depth;
                if (Gdepth == -1 || !graphic.raycastTarget)
                {
                    continue;
                }
                ...
                if (c == null)
                    c = Camera.main;
                Vector2 pointerPosition = c.WorldToScreenPoint(position);
