...
public class infinite_fantasy_pro: MonoBehaviour {
	...
	private bool harp_ambiant_isPlaying;
	private bool baroque_guitar_isPlaying;
	...
	public bool battle;
	public bool harp_ambiant;
	public bool baroque_guitar;
	...
	private int random_other_ambiant;
	...
	private float audio_med_vol = -120.0f;
	private float audio_forte_vol = -180.0f;
    ...
    public Object[] AudioArray_soft_adventure;
    public Object[] AudioArray_med_adventure;
    public Object[] AudioArray_forte_adventure;
    public Object[] AudioArray_end_soft_adventure;
    public Object[] AudioArray_end_med_adventure;
    public Object[] AudioArray_end_forte_adventure;

    public Object[] AudioArray_soft_dark;
    public Object[] AudioArray_med_dark;
    public Object[] AudioArray_forte_dark;
    public Object[] AudioArray_end_soft_dark;
    public Object[] AudioArray_end_med_dark;
    public Object[] AudioArray_end_forte_dark;

    public Object[] AudioArray_soft_mysterious;
    public Object[] AudioArray_med_mysterious;
    public Object[] AudioArray_forte_mysterious;
    public Object[] AudioArray_end_soft_mysterious;
    public Object[] AudioArray_end_med_mysterious;
    public Object[] AudioArray_end_forte_mysterious;

    public Object[] AudioArray_soft_happy;
    public Object[] AudioArray_med_happy;
    public Object[] AudioArray_forte_happy;
    public Object[] AudioArray_end_soft_happy;
    public Object[] AudioArray_end_med_happy;
    public Object[] AudioArray_end_forte_happy;

    public Object[] AudioArray_soft_heroic;
    public Object[] AudioArray_med_heroic;
    public Object[] AudioArray_forte_heroic;
    public Object[] AudioArray_end_soft_heroic;
    public Object[] AudioArray_end_med_heroic;
    public Object[] AudioArray_end_forte_heroic;

    public Object[] AudioArray_soft_sad;
    public Object[] AudioArray_med_sad;
    public Object[] AudioArray_forte_sad;
    public Object[] AudioArray_end_soft_sad;
    public Object[] AudioArray_end_med_sad;
    public Object[] AudioArray_end_forte_sad;

    public Object[] AudioArray_forte_battle;
    public Object[] AudioArray_end_forte_battle;

    public Object[] AudioArray_ambiant_light;
    public Object[] AudioArray_ambiant_dark;
    public Object[] AudioArray_background;

    public Object[] AudioArray_ambiant_harp;
    public Object[] AudioArray_ambiant_baroque_guitar;


    public Object[] AudioArray_demo;
	...
	void Start () {
		...
		AudioArray_ambiant_harp = Resources.LoadAll("ambiant/harp",typeof(AudioClip));
		AudioArray_ambiant_baroque_guitar = Resources.LoadAll("ambiant/baroque_guitar",typeof(AudioClip));
	...
	public void Fantasy_Play(){
		...
		if (y == 9 & !ambiant_light &!ambiant_dark & !harp_ambiant & !baroque_guitar & play_transition) {
			PlayTransition();
			SetTempo ();
		}
		if (y == 10) {
		...
		if (y == 5){
			if (harp_ambiant | baroque_guitar){
				if (!main_theme_isPlaying){
					y = 1;
				}
			}
		...
		if (y == 9 & !harp_ambiant & !baroque_guitar) {
			y = 1;
		}
		
		
		
		if (y == 5 & !ambiant_light & !ambiant_dark & !harp_ambiant & !baroque_guitar & !ambiant_isPlaying & play_transition) {
		...
		if (y == 1 & !play_transition){
			...
			if (!ambiant_light & !ambiant_dark & !harp_ambiant & !baroque_guitar){
	...
	public void Ambiant_Harp_onClick(){
		stop_music = false;
		reset = false;
		start = true;
	...
	public void Ambiant_Baroque_Guitar_onClick(){
		stop_music = false;
		reset = false;
		start = true;
	...
	public void RandomStructure(){
		...
		random_other_ambiant = Random.Range (0, AudioArray_ambiant_harp.Length);
	...
	public void SetVolumes(){
        ...
        audio_soft1.volume = .7f * setting;
        audio_soft2.volume = .7f * setting;

        audio_med1.volume = 0.5f * setting;
        audio_med2.volume = 0.5f * setting;

        audio_forte1.volume = 0.3f * setting;
        audio_forte2.volume = 0.3f * setting;
        ...
        if (muted)
        {
            audio_soft1.volume = 0;
            audio_soft2.volume = 0;

            audio_med1.volume = 0;
            audio_med2.volume = 0;

            audio_forte1.volume = 0;
            audio_forte2.volume = 0;
        }
    }
	...
	public void SetMood(){
		...
		if(switch_audio_source){
			...
			if (harp_ambiant){
				audio_ambiant1.clip = AudioArray_ambiant_harp [random_other_ambiant] as AudioClip;
				
			}
			if (baroque_guitar){
				audio_ambiant1.clip = AudioArray_ambiant_baroque_guitar [random_other_ambiant] as AudioClip;
		...
		if(!switch_audio_source){
			...
			if (harp_ambiant){
				audio_ambiant2.clip = AudioArray_ambiant_harp [random_other_ambiant] as AudioClip;
				
			}
			if (baroque_guitar){
				audio_ambiant2.clip = AudioArray_ambiant_baroque_guitar [random_other_ambiant] as AudioClip;
