...
public class WFXDemoGUI : MonoBehaviour
{
    ...
    private int currentWeaponNomber = 0;
    ...
    void ChangeCurrent(int delta) {
        ...
        //if (currentNomber==10) {
        //    var mr = currentWeaponInstance.GetComponentsInChildren<MeshRenderer>();
        //    foreach (var meshRenderer in mr) {
        //        meshRenderer.enabled = false;
        //    }
        //    var smr = currentWeaponInstance.GetComponentsInChildren<SkinnedMeshRenderer>();
    ...
    private void ChangeColor()
    {
        ...
        foreach (var meshMat in meshMats) {
            ...
            if (meshMat.mat.HasProperty("_TintColor"))
            {
                SetMatHUEColor(meshMat.mat, "_TintColor", colorHUE);
            }
            if (meshMat.mat.HasProperty("_CoreColor"))
            {
                SetMatHUEColor(meshMat.mat, "_CoreColor", colorHUE);
            }
            if (meshMat.mat.HasProperty("_MainColor"))
            {
                SetMatHUEColor(meshMat.mat, "_MainColor", colorHUE);
            }
            if (meshMat.mat.HasProperty("_RimColor"))
            {
                SetMatHUEColor(meshMat.mat, "_RimColor", colorHUE);
            }
        }
