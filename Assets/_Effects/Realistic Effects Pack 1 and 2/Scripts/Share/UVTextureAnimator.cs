...
internal class UVTextureAnimator : MonoBehaviour
{
  ...
  public void SetInstanceMaterial(Material mat, Vector2 offsetMat)
  {
    ...
    private void InitDefaultVariables()
    {
        ...
        if (currentRenderer.material.HasProperty("_MainTex"))
        {
        ...
        else
        {
            ...
            Debug.LogWarning("UVTextureAnimation '" + currentRenderer.material.name + "' does not have property _MainTex");
        }
        ...
        else if (currentRenderer != null)
        {
            ...
            if (IsBump)
            {
                if (currentRenderer.material.HasProperty("_BumpMap"))
                {
                ...
                {
                    Debug.LogWarning("UVTextureAnimation '" + currentRenderer.material.name + "' does not have property _BumpMap");
                    IsBump = false;
                }
            }
            if (IsHeight)
