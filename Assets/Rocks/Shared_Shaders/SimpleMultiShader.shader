Shader "Custom/SimpleMultitexture" {
	Properties{
	...
	_gloss1("Smoothness", Range(0,1)) = 0.1
		...
		CGPROGRAM
#pragma surface surf Standard noforwardadd nometa //fullforwardshadows --Added noforwardadd nometa
#pragma target 3.0
	...
	void surf(Input IN, inout SurfaceOutputStandard output) {
		...
		output.Metallic = _metal1;
		output.Smoothness = _gloss1;
	}
	ENDCG
	}
		FallBack "Diffuse"
